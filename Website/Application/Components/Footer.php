<footer class="page-footer center-on-small-only stylish-color-dark mt-auto">
	...
	<div class="footer-copyright">
		<div class="container-fluid text-center pt-2 pb-2">
			<span>
				<?= PROJECT["NAME"] ?> is made with <i class="material-icons vertical-align-middle pb-2px fs-1rem" data-toggle="tooltip" title="" data-original-title="lots of love <3">favorite</i> by <a href="<?= REPOSITORY["URL"] ?>/graphs/contributors">many different contributors</a>.
			</span>
		</div>
	</div>
</footer>
